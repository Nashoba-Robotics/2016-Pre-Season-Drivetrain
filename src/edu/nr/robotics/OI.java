...
public class OI {
	...
	private OI() {
		...
		new JoystickButton(operatorRight, 1).whenPressed(new DriveConstantCommand(false, true, false, 1));
		new JoystickButton(operatorRight, 2).whenPressed(new DriveConstantCommand(false, true, false, 0));
